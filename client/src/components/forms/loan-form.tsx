...
import { formatCurrency, addDaysToDate, normalizeDate, createConsistentDate, getLocalDateString, getTodayLocalDate } from "@/lib/utils";
...
export default function LoanForm({ open, onOpenChange, onSuccess }: LoanFormProps) {
  ...
  const form = useForm<LoanFormValues>({
    ...
    defaultValues: {
      ...
      fecha_prestamo: getTodayLocalDate(),
      numero_semanas: "16",
