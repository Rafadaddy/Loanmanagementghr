...
export function FullScreenLoading({ text, className }: { text?: string; className?: string }) {
  return (
    <div className={cn("fixed inset-0 z-[9999] bg-black/70 backdrop-blur-sm flex flex-col items-center justify-center", className)}>
      <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 shadow-2xl border border-white/20 animate-pulse">
